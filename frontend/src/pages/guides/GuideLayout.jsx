  ...
  return (
    <div>
      ...
      <article className="container-p py-10 max-w-3xl text-slate-800 leading-8 guide-prose">
        ...
        {/* About the Author — full bio card at end of article (E-E-A-T signal
            AdSense reviewers look for on published editorial content) */}
        {author && (
          <div className="mt-10 pt-8 border-t border-slate-200 not-prose">
            ...
            <div className="card p-5 bg-gradient-to-bl from-brand-50/50 to-white border-brand-100">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <Link to={`/author/${bylineKey.author}`} className="font-extrabold text-slate-900 text-lg hover:text-brand-700 transition">
                    {author.name}
                  </Link>
                  ...
                  <Link to={`/author/${bylineKey.author}`} className="text-brand-700 text-sm font-semibold hover:underline inline-flex items-center gap-1">
